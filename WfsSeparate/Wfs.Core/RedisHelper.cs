...
namespace Wfs.Core
{
    ...
    public class RedisHelper
    {
        ...
        /// <param name="redisValue"></param>
        /// <returns></returns>
        public async Task<string> StringGetAsync(string redisKey, string redisValue)
        {
        ...
        {
            Console.WriteLine("{0}:{1}", "ConnMultiplexer_ConfigurationChangedBroadcast",e.EndPoint);
        }
        ...
        {
            Console.WriteLine("{0}:{1}", "ConnMultiplexer_InternalError", e.Exception);
        }
        ...
        {
            Console.WriteLine("{0}:{1}-{2} To {3}-{4}", "ConnMultiplexer_HashSlotMoved", "e.OldEndPoint", e.OldEndPoint, "e.NewEndPoint",e.NewEndPoint);
        }
        ...
        {
            Console.WriteLine("{0}:{1}","ConnMultiplexer_ConfigurationChanged", e.EndPoint);
        }
        ...
        {
            Console.WriteLine("{0}:{1}", "ConnMultiplexer_ErrorMessage", e.Message);
        }
        ...
        {
            Console.WriteLine("{0}:{1}", "ConnMultiplexer_ConnectionFailed", e.Exception);
        }
        ...
        {
            Console.WriteLine("{0}:{1}", "ConnMultiplexer_ConnectionRestored", e.Exception);
        }
